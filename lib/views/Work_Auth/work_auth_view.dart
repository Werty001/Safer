...
class WorkAuthView extends StatefulWidget {
  const WorkAuthView({Key? key}) : super(key: key);

  @override
  _WorkAuthViewState createState() => _WorkAuthViewState();
}

class _WorkAuthViewState extends State<WorkAuthView> {
